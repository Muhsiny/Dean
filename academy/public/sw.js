const CACHE='beheshti-academy-v6-academy-shell';
const SHELL=['/','/index.html','/styles.css','/v3.css','/polish-v4.css','/v5.css','/v6.css','/curriculum-v3.js','/course-v5-extra.js','/readings-v5.js','/lesson-graph-v6.js','/app-v5.bundle.js','/academy-v6.js','/neon-bridge.bundle.js','/manifest-v3.webmanifest','/icon.svg'];
