...
android { namespace = "org.sayeh.wificontrol"; compileSdk = 35
    defaultConfig { applicationId = "org.sayeh.wificontrol"; minSdk = 23; targetSdk = 35; versionCode = 1; versionName = "1.0.0" }
}
